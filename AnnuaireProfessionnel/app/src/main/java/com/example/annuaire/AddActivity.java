...
public class AddActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(id){
            case R.id.save :
            {
                database.personneDao().insert(new Personne(firstName.getText().toString() + " " + lastName.getText().toString(),email.getText().toString(),job.getText().toString(),phone.getText().toString()));
